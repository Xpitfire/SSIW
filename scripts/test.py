...
def get_parser() -> CfgNode:
    ...
    parser.add_argument('--config', type=str, default='test_720_ss', help='config file') # TODO: repo error
...
def main_worker(local_rank: int, cfg: dict):
    if cfg.distributed:
        global_rank = local_rank # TODO: repo error
        world_size = cfg.gpus_num
        
        torch.cuda.set_device(global_rank)
        dist.init_process_group(backend="nccl", # TODO: repo error
